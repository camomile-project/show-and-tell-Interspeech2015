...
A video presenting the annotation process was recently published on Youtube \footnote{https://www.youtube.com/watch?v=PX46s1kcUGY}. All the code that supports the camomile server, client and active learning is available on the \textit{camomile github} \cite{urlgithub}.
